            ...
            services.AddSitecoreRenderingEngine(
                options =>
                {
                    options
                        ...
                        .AddModelBoundView<ArticleListModel>("ArticleListRendering")
                        .AddModelBoundView<ProductListModel>("ProductListRendering")
                        .AddModelBoundView<ArticleModel>("Article")
                        .AddModelBoundView<ProductModel>("Product")
                        .AddModelBoundView<HeroBannerModel>("HeroBanner")
                        .AddModelBoundView<TextWithImageModel>("TextWithImage")
                        .AddModelBoundView<SimpleTextModel>("SimpleText")
                        .AddModelBoundView<ArticleCardModel>("ArticleCardRendering")
